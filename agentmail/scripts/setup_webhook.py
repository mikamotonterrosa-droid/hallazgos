...
Usage:
    # Create webhook
    python3 setup_webhook.py --url "https://myapp.com/webhook" --create

    # List existing webhooks
    python3 setup_webhook.py --list

    # Delete webhook
    python3 setup_webhook.py --delete "webhook_id"

    # Test webhook with simple Flask receiver (for development)
    python3 setup_webhook.py --test-server
